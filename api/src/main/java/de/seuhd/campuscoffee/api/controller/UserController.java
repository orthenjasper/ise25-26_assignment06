...
public class UserController {
    //completed: Implement user controller
...
@Operation(
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            ...
                            description = "Validation failed: e.g. missing required fields or ID mismatch."
                    ),
                    @ApiResponse(
                            responseCode = "404",
                            content = @Content(
    ...
    public ResponseEntity<Void> delete(
        ...
        userService.delete(id); // throws NotFoundException if User does not exist
